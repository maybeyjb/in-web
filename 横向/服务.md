...
##总结：
3种服务的横向，都与账密有关，根据目标环境开启哪种服务，就对应使用包里的脚本进行横向，不过大多还是需要先搭隧道，在执行横向。   有的横向需要明文，有的只需要hash值就可以实现横向。属于pth一种。
wmi服务的wmiexec.py，可以不需要明文密码。hash值就可以实现横向
<img width="1206" height="366" alt="image" src="https://github.com/user-attachments/assets/ec41471c-7f5e-4f85-a5b0-4d753c30270b" />

smb服务的psexec.py（cs那个插件）和smbexec.py都是针对smb服务的，也不需要明文。
smbexec.py隐蔽性更好但交互性较弱，psexec.py相反
<img width="1210" height="297" alt="image" src="https://github.com/user-attachments/assets/3c076b1a-8dc5-4b8c-9856-b1e412018731" />
