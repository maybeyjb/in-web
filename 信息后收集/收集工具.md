...
<img width="1103" height="1013" alt="image" src="https://github.com/user-attachments/assets/abb3126c-ac2a-493d-8276-98f3ce3a0c54" />
...
<img width="1367" height="316" alt="image" src="https://github.com/user-attachments/assets/3e654622-02f8-452a-9d78-4047766006e4" />


<img width="1367" height="385" alt="image" src="https://github.com/user-attachments/assets/1a78f7aa-bf2d-4dbe-8c57-50bd582b7918" />
...
#### 2、对外打点：
 ...
 #### fscan   Template
 （内网或者域环境）可以在攻击机（隧道或者socks）也可以在目标机器  -- - 可以不复现，和前面一样。
...
####   Adfind 
在域环境下非常强大的信息搜集工具。https://www.joeware.net/freetools/tools/adfind/								可以在本地（攻击机）也能在被控机。本地需要配置host，最好还是被控机。这里因为Dns解析不同，所以让本地和攻击机绑定同一个host，域名解析相同ip。
